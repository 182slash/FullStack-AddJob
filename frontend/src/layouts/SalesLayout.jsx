...
import { BarChart2, Tag, LogOut } from 'lucide-react'
...
const NAV_ITEMS = [
  { to: '/sales/dashboard', Icon: BarChart2, label: 'Dashboard' },
]
...
const SalesLayout = () => {
  ...
  if (user?.role !== 'sales') return <Navigate to="/login" replace />
